...
div.f > div:nth-child(2):lang(non)  { background-color:#edf; border-color:#c00; }
...
div.f > div:nth-child(2):lang(enm)  { background-color:#ee7; border-color:#990; }
div.f > div:nth-child(2):lang(en)   { background-color:#ff3; border-color:#220; }
div.f > div:nth-child(2):lang(sco)  { background-color:#ccf; border-color:blue; }
div.f > div:nth-child(2):lang(wger) { background-color:#fbd; border-color:blue; }
