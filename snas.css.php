...
div.f[data-lang="be"] > div:nth-child(1),
...
div.f[data-lang="wger"] > div:nth-child(2) { background-color:#fbd; border-color:blue; }
div.f[data-lang="de"] > div:nth-child(2)   { background-color:#f99; border-color:black; }
...
div.f[data-lang="be"] > div:nth-child(2)   { background-color:#efe; border-color:green; }
