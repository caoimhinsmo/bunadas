...
<p>The “Tree” button is probably the best thing about Bunadas.  It explores the network to find all the cognates of a word, and it shows them as a minimum spanning tree.  For clearest results, it is usually best to then click on the PIE root and then click “Tree” once more.  In the tree display, clicking the language tag for a word will close (or reopen) that branch of the tree to let you avoid clutter when you need to.</p>

<p>Here is a <a href="../fc.php?f=73833">wordcount</a> for each language which Bunadas deals with at present.</p>

<p style="margin:0.3em;border:1px solid #333;border-radius:0.6em;padding:0.5em;color:#333;font-size:80%">The idea of a tree of descendants can go “wrong”, or at least exhibit somewhat pathological behaviour.  Look at the <a href="/teanga/bunadas/fc.php?f=62995">tree for PIE tḱey</a>-, for example.  In all the descendants, you can at least see some reflex of the ‘tḱ’ from the PIE root - except in the branch near the bottom of the page derived from Latin sinō and pōnō.  The ‘s’ of sinō comes from the ‘tḱ’ of tḱey-, but this has disappeared in pōnō after prefixing by po-, and pōnō has absolutely nothing left of the original tḱey-; everything comes from prefixes and suffixes added later.  This is even more extreme by the time we reach English “compose”.  On each step of the way from “tḱey-” to “compose”, each word has clearly been derived from the word immediately before it, and yet no smidgeon of tḱey- can be found in the word “compose”.  There are other examples such as PIE <a href="/teanga/bunadas/fc.php?f=50543">gʰed-</a> → English “prison” (as well as the more transparent English “get”), but fortunately, this situation does not occur often enough to be a big problem.</p>
