...
<p>The editing facilities are good, and can be tried out by anyone on an out-of-date copy of the database simply by switching from “bunadas” to “bunTest” on the dropdown on the bottom-right of the main page.  Words can be dragged and dropped from group to group (on all browsers except Internet Explorer).  Straight drag copies the word, Ctrl+drag moves the word.  Clicking on a word takes you to the page for the word, which shows any clusters it is in, any alternative spellings, sometimes IPA, etc.</p>
...
<p>Bunadas has a multilingual interface, currently available in six languages,
<a href="//www.smo.uhi.ac.uk/teanga/bunadas/?hl=en">English</a>,
<a href="//www.smo.uhi.ac.uk/teanga/bunadas/?hl=gd">Gàidhlig</a>,
<a href="//www.smo.uhi.ac.uk/teanga/bunadas/?hl=ga">Gaeilge</a>,
<a href="//www.smo.uhi.ac.uk/teanga/bunadas/?hl=fr">Français</a>,
<a href="//www.smo.uhi.ac.uk/teanga/bunadas/?hl=br">Brezhoneg</a>, and
<a href="//www.smo.uhi.ac.uk/teanga/bunadas/?hl=de">Deutsch</a>.
You can switch interface language via the dropdown at the top of any page, or you can link straight to the interface in any language by using a url with an ‘hl’ (host language) paramter such as <a href="https://www.smo.uhi.ac.uk/teanga/bunadas/?hl=en">https://www.smo.uhi.ac.uk/teanga/bunadas/?hl=en</a>.
