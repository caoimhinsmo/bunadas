<?php
  ...
  try {
    ...
    $hl = $T::hl0();
    $T_Cruthaich_facal_ur  = $T->_('Cruthaich facal ùr');
    $T_Atharraich_facal    = $T->_('Atharraich facal');
    ...
    $T_Chan_eil_facal_f    = $T->_('Chan eil facal %d ann idir');
    $T_Feumaidh_tu_canan   = $T->_('Feumaidh tu cànan a thaghadh');
    $T_Feumaidh_tu_facal   = $T->_('Cha do sgrìobh thu facal sam bith');
    $T_Atharrachadh_soirbh = $T->_('Atharrachadh soirbheachail');
    $T_Facal_ur_ann        = $T->_('Chaidh am facal a chur ann');
    $T_Facal_ann_mu_thrath = $T->_('Facal_ann_mu_thrath');
