<?php
  ...
  try {
    ...
    $hl = $T::hl0();
    $T_Cruthaich_drong_ur  = $T->_('Cruthaich drong ùr');
    $T_Atharraich_drong    = $T->_('Atharraich drong');
    $T_topar               = $T->_('topar');
    $T_fis                 = $T->_('fis');
    $T_Sabhail             = $T->_('Sàbhail');
    $T_Parameter_mi_iom    = $T->_('Parameter_mi_iom');
    $T_Chan_eil_drong_d    = $T->_('Chan_eil_drong_d');
    $T_Feumaidh_tu_topar   = $T->_('Feumaidh_tu_topar');
    $T_Drong_ann_mu_thrath = $T->_('Drong_ann_mu_thrath');
    $T_failig_INSERT       = $T->_('failig_INSERT');
